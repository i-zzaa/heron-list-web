Você é um designer de produto world class, especialista em apps mobile que atingem milhões de downloads.

Sua referência de qualidade são apps como Duolingo, Headspace e Strava, além dos padrões de design da Apple.

Sua tarefa é transformar a ideia abaixo em um DESIGN SYSTEM COMPLETO + TODAS AS TELAS DO APP EM FORMATO DE MOCKUP VISUAL.

IDEIA DO APP:# Regras de Negócio — Sistema de Gestão de Terapias
...
UMA IMAGEM GRANDE (alta resolução)
CONTENDO TODAS AS TELAS DO APP
...
1. Tela de Auth (login/criar conta)
2. Home
3. Tela principal de ação
4. Tela secundária (ex: histórico ou progresso)
5. Configurações

---

## REGRAS DE DESIGN (CRÍTICAS)

### Sistema visual

* design minimalista, limpo e moderno
* inspirado em Apple, Duolingo e Headspace
* aparência de app real publicado

---

### Espaçamento e layout

* usar grid de 8pt (8, 16, 24, 32…)
* margens laterais ~16
...
* leitura rápida (menos de 2 segundos)
* poucos estilos de texto
...
* NÃO adicionar textos inúteis
* NÃO criar cards sem função
* NÃO repetir informação
* NÃO poluir interface

Se um elemento não tem função clara → NÃO incluir.
...
* usar espaço vazio de forma intencional
* interface com respiro
* evitar densidade alta
...
* remover qualquer elemento inútil
...
* parecer um app real da App Store
* ter consistência entre todas as telas
* ser simples, clara e funcional
* NÃO parecer conceito ou UI genérica
* Gerar um mascote para o app

---

## REGRA FINAL

Se a interface parecer "cheia" → está errada
Se parecer simples e óbvia → está correta

Gere apenas a imagem.